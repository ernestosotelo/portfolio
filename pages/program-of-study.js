        ...
        <table className={styles.table}>
          ...
          <tr>
            ...
            <td className={styles.courseDescription}>
              ...
              relationship between technology education and related disciplines.
              Analyzes the theory, models, and literature that constitute the
              foundation of technology education. Synthesizes relevant research
          ...
          <tr>
            ...
            <td className={styles.courseDescription}>
              A critical appraisal of current psychological findings relevant to
          ...
          <tr>
            <td>ECI 709</td>
            <td>
              Special Problems In Curriculum and Instruction: Learning Sciences
            </td>
          ...
          <tr>
            ...
            <td>Dr Julia McKeown</td>
            <td className={styles.courseDescription}>
              Examination of learning theories and research-based principles to
              design and apply appropriate digital tools to create maximally
          ...
          <tr>
            ...
            <td className={styles.courseDescription}>
              ...
              development of advanced technology-enhanced learning environments.
            </td>
            <td>November 17, 2020</td>
          </tr>
          <tr>
            ...
            <td className={styles.courseDescription}>
              Cultural Investigations and Technical Representations in Education
              Examination of contemporary approaches that educators can use to
              help their students construct cultural understanding in education
              settings through investigations and technical representations of
              culture with emerging tools (e.g., mapped cultural tours, AR/VR
              heritage exhibition, documentary, social media, games,
              fabrication, data analytics and visualization). November 17, 2020.
            </td>
            <td>November 17, 2020</td>
          </tr>
          <tr>
            ...
            <td className={styles.courseDescription}>
              ...
              teaching techniques and curricular directions designed to improve
              school experiences for diverse populations in K-12 settings.
            </td>
            <td>April 30 2021</td>
          </tr>
          <tr>
            ...
            <td className={styles.courseDescription}>
              Characteristics and selection of various media for instruction and
              their use in educational settings. Design and production of
              instructional materials. Analysis of research in the field.
              Individualized projects and assignments. Application of grounded
              research and theory concerning learning to design of instructional
              materials. Structured projects and practical experiences used to
              transfer design principles and evaluate instructional products.
            </td>
            <td>April 30 2021</td>
          </tr>
          <tr>
            <td>ECI 652</td>
            <td>Field-Based Applications of Learning Design and Technology</td>
